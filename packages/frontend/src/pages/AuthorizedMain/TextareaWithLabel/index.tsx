...
export const TextareaWithLabel:React.FC<FieldProps & OwnProps> = ({field, form, id, className, required, label, ...props}) => {
    ...
    return (
        <div className={classNames("flex flex-col", className)}>
            ...
            <textarea className={"bg-[rgba(0,0,0,.25)] rounded-[5px] py-3 outline-0 transition-colors duration-300 border-[1px] border-[rgba(0,0,0,0)] focus:border-primary-1 px-2.5 text-high-emphasis mt-1"} {...field} {...props} id={id+""+rand}/>
        </div>
    )
}